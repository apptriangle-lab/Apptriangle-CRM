...
export function LeaveRejectConfirmBody({
  ...
  const progressPct =
    ...
    credited > 0 ? Math.min(100, Math.max(0, (remainingNow / credited) * 100)) : 0;
  ...
  return (
    ...
    <div className={leaveConfirmBodyRootClass}>
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className={cn(leaveConfirmHeaderIconWrapClass, "bg-red-50")}>

          <div className={cn(leaveConfirmHeaderIconInnerClass, "bg-red-800")}>
        ...
        <h2 className={leaveConfirmTitleClass}>Confirm Rejection</h2>

        <p className={leaveConfirmSubtitleClass}>

          Please review and confirm rejecting the leave request for{" "}
      ...
      <div className={leaveConfirmDetailsSectionClass}>
        ...
        <div className="grid grid-cols-2 gap-x-4">
          ...
          <div className="min-w-0 text-right">
            ...
            <p className="text-sm font-bold leading-snug text-red-600 [@media(max-height:820px)]:text-[13px]">
        ...
        <div className={leaveConfirmBalanceCardClass}>
          ...
          <div className="mb-2.5 flex items-end justify-between gap-3 [@media(max-height:820px)]:mb-2">
            ...
            <div className="min-w-0 text-right">
              ...
              <p className="text-[11px] text-slate-500">After rejection</p>

              <p className={cn(leaveConfirmBalanceAfterClass, "text-slate-700")}>

                {formatLeaveDays(remainingNow)} {remainingNow === 1 ? "day" : "days"} left
          ...
          {(balance.additionalOutstanding > 0 || balance.additionalIfApproved > 0) && (
            ...
            <div className="mt-2 space-y-0.5 border-t border-slate-200/60 pt-2 text-[10px] leading-snug text-slate-600 [@media(max-height:820px)]:text-[9px]">
              ...
              {balance.additionalIfApproved > 0 ? (
                ...
                <p className="line-clamp-1" title={`Would use ${formatLeaveDays(balance.additionalIfApproved)} days beyond quota if approved.`}>

                  Would use {formatLeaveDays(balance.additionalIfApproved)} day

                  {balance.additionalIfApproved === 1 ? "" : "s"} beyond quota if approved.
      ...
      <div className="rounded-2xl border border-red-200 bg-red-50/60 p-3.5 ring-1 ring-red-100/80 [@media(max-height:820px)]:rounded-xl [@media(max-height:820px)]:p-3">
        <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.12em] text-red-700">
        ...
        <Textarea
          ...
          rows={2}
          className="min-h-[52px] max-h-[52px] resize-none overflow-y-auto rounded-xl border border-red-200 bg-white px-3.5 py-2 text-[13px] leading-snug text-slate-800 shadow-sm placeholder:text-slate-400 focus-visible:border-red-400 focus-visible:ring-2 focus-visible:ring-red-500/30 [@media(max-height:820px)]:min-h-[44px] [@media(max-height:820px)]:max-h-[44px] [@media(max-height:820px)]:py-1.5 [@media(max-height:820px)]:text-xs"
        />
      </div>
