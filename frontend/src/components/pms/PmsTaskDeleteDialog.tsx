...
export function PmsTaskDeleteDialog({
  task,
  open,
  onOpenChange,
  onConfirm,
    ...
    <Dialog open={open} onOpenChange={(v) => (v ? onOpenChange(true) : handleClose())}>
      ...
      >
        <div className="relative px-6 pb-5 pt-6">
          ...
          <div className="flex gap-4 pr-8">
            ...
            <div className="min-w-0 flex-1 pt-0.5">
              ...
              <p className="mt-1.5 text-[13px] leading-relaxed text-slate-500">
                This task will be removed from your task list.
              </p>
            </div>
          </div>
          ...
          {subtaskCount > 0 && (
            <div className="mt-3 flex items-start gap-3 rounded-xl border border-amber-200/90 bg-amber-50/90 px-4 py-3">
              ...
              <div className="min-w-0 pt-0.5">
                ...
                <p className="mt-0.5 text-[12px] leading-relaxed text-amber-800/90">
                  All nested subtasks will be deleted together with this task.
                </p>
              </div>
            </div>
          )}
        ...
        <div className="flex items-center justify-end gap-2 border-t border-slate-200 bg-slate-50/80 px-6 py-3.5">
          ...
          <Button
            ...
            className="h-9 rounded-lg bg-red-600 px-4 text-[13px] font-semibold text-white shadow-sm hover:bg-red-700"
          >
            {loading ? (
              <>
